let Tên= prompt("Nhập tên người nhận")
let DD= prompt("Nhập địa điểm")
let N= prompt("Nhập ngày")
let T= prompt("Nhập tháng ")
let y= prompt("Nhập năm")
document.write(Tên = "Thương nhớ,")
document.write('<br/>')
document.write('<br/>')
document.write('<br/>')
...
document.write('<br/>')
document.write('<br/>')
document.write(DD+", "+"Ngày "+N+"Tháng" +T+" năm"+y+".")
